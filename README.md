...
email text,
company_name text,
role text check (role in ('owner', 'developer', 'contractor', 'architect', 'engineer', 'quantity_surveyor', 'project_manager', 'site_manager', 'subcontractor', 'supplier', 'manufacturer', 'distributor', 'logistics', 'finance', 'admin')),
